...
class _ForgotPasswordState extends State<ForgotPassword> {
  ...
  void passwordUpdate(String email, String pass){
    BlocProvider.of<HomeBloc>(context).add(PasswordUpdateEvent(email: email, pass: pass));
  }
    ...
    setState(() {
      switch (emailCodeSendState.apiState) {
        ...
        case ApiStatus.SUCCESS:
          ...
          Utility.showSnackBar(scaffoldContext: context, message: 'Password updated successfully');
          _isPassUpLoading = false;

          break;
        case ApiStatus.ERROR:
          Log.v("Error handleVerifyOtp ..........................${emailCodeSendState.error}");
          _isPassUpLoading = false;
          Utility.showSnackBar(scaffoldContext: context, message: 'Password Update Error');
          break;
        case ApiStatus.INITIAL:
          break;
      }
