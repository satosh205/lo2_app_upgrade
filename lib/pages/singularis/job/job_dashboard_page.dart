                                                                ...
                                                                label:
                                                                  ...
                                                                  child: Text(
                                                                      ...
                                                                      style: Styles
                                                                        ...
                                                                        size:
                                                                            12,
                                                                        color: selectedIdList.contains(domainFilterList!.data!.list[i].id)
      ...
      child: Column(
        ...
        children: [
          ...
          if (int.parse('${allJobListResponse?.data?.length}') > 4) ...[
            renderJobSecondPositionList(
                (allJobListResponse?.data!.length)! - 4),
          ],
        ],
      ),
    );
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Text(
                                              '${allJobListResponse?.data![index]!.experience != null ? allJobListResponse?.data![index]!.experience : "0"} Yrs',
                                              style: Styles.regular(
                                                  size: 12,
                                                  color:
                                                      ColorConstants.GREY_6)),
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Text(
                                              '${allJobListResponse?.data![newIndex]!.experience != null ? allJobListResponse?.data![newIndex]!.experience : "0"} Yrs',
                                              style: Styles.regular(
                                                  size: 12,
                                                  color:
                                                      ColorConstants.GREY_6)),
