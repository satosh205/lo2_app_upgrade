...
class SwayamTrainingDetailProvider extends BaseState {
  ...
  SwayamTrainingDetailProvider(@required this.trainingService, this.program) {
    getTraningDetail();
  }
  ...
  void getTraningDetail() {
    ...
    trainingService.getTrainingDetail(program.id).then((response) {
      ...
      if (apiResponse.success) {
        ...
        modules =
            trainingDetailResponse.data?.list?.first.modules as List<Modules>;
        debugPrint(
