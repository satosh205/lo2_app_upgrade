  ...
  Widget build(BuildContext context) {
    return BlocManager(
        ...
        child: BlocListener<HomeBloc, HomeState>(
            ...
            centerTitle: true,
            title: Text(
              widget.isEditMode == true ? "Edit Experience" : "Add Experience",
                          ...
                          Padding(
                              ...
                              child: SingleChildScrollView(
                                ...
                                size: 14, color: Color(0xff0E1638)),
                                    ...
                                    CustomTextField(
                                      ...
                                      validate: true,
                                      maxChar: 500,
                                      validationString: 'Please enter describe',
                                      hintText:
                            ...
                            child: InkWell(
                              ...
                              if (Platform.isIOS) {
                                ...
                                if (result != null)
                                  setState(() {
                                    uploadCerti = File(result!.files.first.path!);
                                  });
                              } else {
                                final pickedFileC =
        ...
        case ApiStatus.SUCCESS:
          Log.v("Success Add Experience....................");
           ScaffoldMessenger.of(context)
                                              .showSnackBar(
                                             SnackBar(
                                                content: Text(widget.isEditMode == true ? 'Experience edited' :
                                                    'Experience added')),
                                          );
