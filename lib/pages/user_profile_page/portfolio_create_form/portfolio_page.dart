                    ...
                    if (isPortfolioLoading == false) ...[
                      ...
                      if (isPortfolioLoading == false)
                        getCertificateWidget(
                            portfolioResponse?.data.certificate),
                      dividerLine(),
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView(
            shrinkWrap: true,
            scrollDirection: Axis.horizontal,
            children: [postCard(imageUrl: 'https://images.unsplash.com/photo-1674708059513-5f77494844db?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw1M3x8fGVufDB8fHx8&auto=format&fit=crop&w=900&q=60'), postCard(imageUrl: 'https://images.unsplash.com/photo-1661961110372-8a7682543120?ixlib=rb-4.0.3&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80')],
          ),
        ),
      ],
    );
  ...
  Widget topRow(String title, Function action, {bool showAddButton = true}) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
            if(!showAddButton)  SizedBox(height: 10,),
