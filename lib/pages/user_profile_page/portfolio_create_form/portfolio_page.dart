  ...
  Widget build(BuildContext context) {
    return BlocManager(
      ...
      child: BlocListener<HomeBloc, HomeState>(
        ...
        return Text('${portfolioResponse?.data.education[index]}');
                        return  Container(
                              margin: EdgeInsets.symmetric(
                                horizontal: 8,
                              ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ClipRRect(
                                          borderRadius: BorderRadius.circular(8),
                                          child: CachedNetworkImage(
                                            imageUrl: '${portfolioResponse?.data.baseFileUrl}${portfolioResponse?.data
                    ...
                    : Text('no portfolio found '),
                dividerLine(),
            if(isPortfolioLoading == false)    getCertificateWidget(portfolioResponse?.data.certificate),
                // dividerLine(),
