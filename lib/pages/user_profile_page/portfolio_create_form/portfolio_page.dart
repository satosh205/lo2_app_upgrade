    ...
    return BlocManager(
      ...
      child:  BlocListener<HomeBloc, HomeState>(
        ...
        child: Scaffold(
          ...
          Center(
            child: SizedBox(
                width: MediaQuery.of(context).size.width * 0.94, child: Divider()),
          ),
          if (editModeEnabled)
            Padding(
              padding: const EdgeInsets.all(8.0),
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: isPortfolioLoading == false  ?  ListView.builder(
                          itemCount: portfolioResponse?.data.portfolio.length,
                          scrollDirection: Axis.horizontal,
